...
class TellaPointProductContainer extends StatefulWidget {
  ...
  @override
  State<TellaPointProductContainer> createState() =>
      _TellaPointProductContainerState();
}

class _TellaPointProductContainerState
    extends State<TellaPointProductContainer> {
  @override
            ...
            child: Padding(
              ...
              child: Container(
                ...
                child: Row(
                  ...
                  children: [
                    _buildWalletInfo(walletInfo, theme),
  ...
  Widget _buildWalletInfo(walletInfo, AdaptiveThemeMode theme) {
    return Row(
  ...
  Future<void> redeemPoint(
      BuildContext context, AdaptiveThemeMode theme) async {
    await showDialog(
      context: context,
